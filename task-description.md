Ogólne wymagania dla projektu 
1. Przygotowanie danych 
*  Wybór odpowiedniego zbioru danych (proponowane zbiory danych są 
podlinkowane). 
...
*  Porównanie skuteczności metod (dokładność, precyzja, recall, F1-score, MSE, R² 
itd.). 
...
*  Dyskusja na temat napotkanych problemów. 
...
Wymagania: 
*  Przygotowanie danych (usuwanie braków, normalizacja). 
*  Porównanie trzech metod predykcji: 
   -  Regresja liniowa 
